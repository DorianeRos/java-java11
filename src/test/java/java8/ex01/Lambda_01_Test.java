...
public class Lambda_01_Test {
	...
	public void test_filter_by_age() throws Exception {
		...
		// TODO result ne doit contenir que des personnes adultes (age >= 18) REPONSE :
		// "p->p.getAge()>=18"
		 ...
		 * OU -->
		 * 
		 * assert result.size() == 83; for (Person person : result) { assert
		 * person.getAge() > 17; }
		 *
		 */
	...
	public void test_filter_by_firstname() throws Exception {
		...
		// REPONSE p->p.getFirstname().equals("first_10")
